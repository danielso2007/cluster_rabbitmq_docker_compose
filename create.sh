...
JOIN_RABBIT2_RABBIT1="rabbitmqctl stop_app; rabbitmqctl join_cluster rabbit@rabbitmq-node-1; rabbitmqctl start_app; rabbitmqctl set_user_tags quest administrator"
JOIN_RABBIT3_RABBIT1="rabbitmqctl stop_app; rabbitmqctl join_cluster rabbit@rabbitmq-node-1; rabbitmqctl start_app; rabbitmqctl set_user_tags quest administrator"
JOIN_RABBIT4_RABBIT1="rabbitmqctl stop_app; rabbitmqctl join_cluster rabbit@rabbitmq-node-1; rabbitmqctl start_app; rabbitmqctl set_user_tags quest administrator"
